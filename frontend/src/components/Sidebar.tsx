    ...
    <aside className="flex h-full w-60 flex-col border-r border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900">
      ...
      <div className="space-y-1 p-2">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm text-neutral-600 hover:bg-neutral-200 dark:text-neutral-400 dark:hover:bg-neutral-700"
        >
          <span>🔍</span>
          Search
          <kbd className="ml-auto rounded border border-neutral-300 bg-white px-1 text-xs text-neutral-400 dark:border-neutral-600 dark:bg-neutral-800">
            ⌘K
          </kbd>
        </button>
      </div>
      ...
      <div className="border-t border-neutral-200 p-2 dark:border-neutral-700">
        <div className="flex items-center gap-2 px-2 py-1">
          ...
          <button
            ...
            title={themeLabel}
            className="rounded p-1 text-neutral-400 hover:bg-neutral-200 hover:text-neutral-700 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
          >
            {themeIcon}
          </button>
          <button
        ...
        <button
          ...
          className="mt-1 w-full rounded px-2 py-1 text-xs text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-700"
        >
          Collapse sidebar
        </button>
      </div>
